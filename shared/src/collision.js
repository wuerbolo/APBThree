// World layout + collision math shared between client and server. This
// used to be hand-mirrored in client/src/utils/collision.js and
// server/src/utils/collision.js with a "keep in sync" comment -- risky as
// the world grows, since nothing enforced it. Both sides now import this
// package instead; each side's own collision.js re-exports it plus
// whatever stays genuinely side-specific (PLAZA on the client is
// render-only, spawn logic on the server is authoritative-only).
